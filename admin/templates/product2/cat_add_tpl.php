...
function get_main_category()
	...
	?>
<h3>Thêm danh mục</h3>
<form name="frm" method="post" action="index.php?com=product2&act=save_cat" enctype="multipart/form-data" class="nhaplieu">	
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=product2&act=man_cat'" class="btn" />
</form>