<h3>Thêm danh mục</h3>
<form name="frm" method="post" action="index.php?com=product3&act=save_list" enctype="multipart/form-data" class="nhaplieu">	    	    
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=product3&act=man_list'" class="btn" />
</form>