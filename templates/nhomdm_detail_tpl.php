...
<?php 
			...
			$idgia  =  addslashes($_GET['idgia']);
			
			switch ($idgia)
			{
				case 1  : $sql_gia =  ' gia <1000000'; 			   break;
				case 2  : $sql_gia =  ' 1000000<= gia and gia<3000000';   break;
				case 3  : $sql_gia =  ' 3000000<= gia and gia<5000000';   break;
				case 4  : $sql_gia =  ' 5000000<= gia and gia<=10000000'; break;
				case 5  : $sql_gia =  ' gia >10000000';            break;
				default : $sql_gia =  ' ';                         break;
			}
			switch ($idgia)
			{
				case 1  : $ten_gia =  'Dưới 1 triệu'; 			   break;
				case 2  : $ten_gia =  'Từ 1 triệu đến 3  triệu';   break;
				case 3  : $ten_gia =  'Từ 3 triệu đến 5  triệu';   break;
				case 4  : $ten_gia =  'Từ 5 triệu đến 10 triệu';   break;
				case 5  : $ten_gia =  'Trên 10 triệu';             break;
				default : $ten_gia =  ' ';                         break;
			}
			$d->reset();
			$sql_tungdanhmuc="select * from #_product where hienthi =1 and $sql_gia and id_list='$idl'    order by stt asc";
			//die($sql_tungdanhmuc);
			$d->query($sql_tungdanhmuc);	
			$result_spnam=$d->result_array();	
			
			$d->reset();
			$sql_laylist="select * from #_product_list where hienthi =1 and id='$idl'";
			$d->query($sql_laylist);	
                ...
                <div class="fshop-breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="danh-muc/<?=$result_laylist["tenkhongdau"]?>-<?=$result_laylist["id"]?>.html"><?=$result_laylist["ten_vi"]?></a></li>
                         <li class="active"><a ><?=$ten_gia?></a></li>
                    </ol>
                </div>
