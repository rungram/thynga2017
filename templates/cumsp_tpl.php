...
<?php 
			...
			$d->reset();
			$sql_tungdanhmuc="select * from #_product where hienthi =1 and giagiam>0 order by stt asc ";
...
<div class="fshop-mainbox">
    <div class="fshop-lprod-top">
            ...
            <div class="col-md-6 col-xs-12">
                <div class="fshop-breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><a href="khuyen-mai.html">Khuyến mãi</a></li>
                    </ol>
                </div>
        ...
        <div class="row fshop-lprod-fillter clearfix">
            <div class="fshop-lprod-fprodname"> <h1>Khuyến mãi</h1> <span>(<?=$total_sp?> sản phẩm)</span></div>
    ...
    <div class="row fshop-lprod-main box-products">
        ...
        <div id="category-products" class="products" data-link="#/dien-thoai" data-page="2" style="position: relative; height: 1734px;">
            <div class="grid-sizer"></div>
                ...
                <div class="p-price">
                <span class="p-current-price"><?php echo number_format ($result_spnam[$i]['giagiam'],0,",",".");?><span>đ</span></span>                			                </div>
                
                <div class="p-price">
                <span class="p-old-price"><?php echo number_format ($result_spnam[$i]['gia'],0,",",".");?><span>đ</span></span>                			                </div>
