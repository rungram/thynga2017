...
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="<?=$rong?>" height="<?=$cao?>">
	...
	<embed type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" src="upload/banner/<?=$row_banner_flash[0]['photo']?>" quality="high" width="<?=$rong?>" height="<?=$cao?>" wmode="transparent">
