        ...
        <div id="main">
			<div class="fshop-mainbox">
                ...
                <div class="fns-menunews">
                    ...
                    <ul class="clearfix">
                        <li><a href="tin-tuc.html" title="">Tin mới</a></li>
                        <?php for($i=0,$count_tll=count($result_tinll);$i<$count_tll;$i++) { ?>    
                        <li <?php if($id==$result_tinll[$i]['id']) echo 'class="active"';?>><a href="tin-tuc-list/<?=$result_tinll[$i]['tenkhongdau']?>-<?=$result_tinll[$i]['id']?>.html" title=""><?=$result_tinll[$i]['ten_vi']?></a></li>
                        <?php } ?> 
                    </ul>
                </div>
            	</div>
