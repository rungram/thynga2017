...
<?php 
			$d->reset();
			$sql_tungdanhmuc="select * from #_product where hienthi =1 and spdc>0 order by stt asc ";
...
<div class="fshop-mainbox">
    <div class="fshop-lprod-top">
            ...
            <div class="col-md-6 col-xs-12">
                <div class="fshop-breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><a href="top-ban-chay.html">Top bán chạy</a></li>
                    </ol>
                </div>
        ...
        <div class="row fshop-lprod-fillter clearfix">
            <div class="fshop-lprod-fprodname"> <h1>Top bán chạy</h1> <span>(<?=$total_sp?> sản phẩm)</span></div>
