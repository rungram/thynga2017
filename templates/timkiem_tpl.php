...
<div class="fshop-mainbox">
    <div class="fshop-lprod-top">
            ...
            <div class="col-md-6 col-xs-12">
                <div class="fshop-breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><a >Tìm kiếm từ khóa : <?=$tukhoa?></a></li>
                    </ol>
                </div>
        ...
        <div class="row fshop-lprod-fillter clearfix">
            <div class="fshop-lprod-fprodname"> <h1>Kết quả tìm</h1> <span>(<?=$total_sp?> sản phẩm)</span></div>
        ...
        <div id="category-products" class="products" data-link="#/dien-thoai" data-page="2" style="position: relative; height: 1734px;">
            <div class="grid-sizer"></div>
                ...
                <?php for($i=0,$count_spnam=count($result_timkiem);$i<$count_spnam;$i++) { ?>    
              		  ...
              		  <div class="p-item cell-1" style="position: absolute; <?php if($result_timkiem[$i]["tc_big"]==3) echo 'left: 33.3333%; top: 289px;' ;else echo 'left:66.6667%;top: 0px;'?>"><div class="p-badge">
                      
                      <img src="upload/sanpham/<?php if($result_timkiem[$i]["tc_big"]==1) echo $result_timkiem[$i]["thumb"]; else echo $result_timkiem[$i]["thumb"] ?>" alt="<?=$result_timkiem[$i]["ten_vi"]?>"></div>
                
                <div class="p-item-bound"><a href="chi-tiet-san-pham/<?=$result_timkiem[$i]['tenkhongdau']?>-<?=$result_timkiem[$i]['id']?>.html" title="" class="p-link-prod"></a><figure class="p-image"><span><a href="chi-tiet-san-pham/<?=$result_timkiem[$i]['tenkhongdau']?>-<?=$result_timkiem[$i]['id']?>.html"><img src="upload/sanpham/<?php if($result_timkiem[$i]["tc_big"]==1) echo $result_timkiem[$i]["thumb"]; else echo $result_timkiem[$i]["thumb_tc"] ?>" alt="<?=$result_timkiem[$i]["ten_vi"]?>"></a></span></figure><div class="p-info"><div class="p-top-info"><div class="p-info-show"><div class="p-name"><a href="chi-tiet-san-pham/<?=$result_timkiem[$i]['tenkhongdau']?>-<?=$result_timkiem[$i]['id']?>.html"><h3><?=$result_timkiem[$i]["ten_vi"]?></h3></a></div>
                
                <div class="p-price"><span class="p-current-price"><?php echo number_format ($result_timkiem[$i]['gia'],0,",",".");?><span>đ</span></span>                    </div>
                ...
                <div class="p-hide-info"><div class="best-seller-order">
                		<?=$result_timkiem[$i]["mota_vi"]?>
               			
                </div>
                
                <div class="p-promotion"><div class="hightlight-des">
                		<?=$result_timkiem[$i]["mota_en"]?>
