  ...
  <div class="mid-title">
    ...
    <div class="clear"></div>
  		...
  		<div class="mid-content">
            ...
            <div class="fhd-cright col-xs-12 col-sm-3">   <div class="fhd-cl-i"><div class="fhd-tits"><h2 class="fhd-titsh">QUẢN LÝ THÔNG TIN</h2></div>
            ...
            <ul class="fhd-cl-lprod mau_nen">
                ...
                <li>
                <a class="fhd-cl-lname" href="gio-hang.html" title="iPhone 7">Giỏ hàng của bạn</a>
                </li>
                 <li>
